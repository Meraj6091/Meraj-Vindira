var question001 = ['Sri Jayawardanapura Kotte is the legislative capital city of Sri Lanka',
        ...
        function next001() {
            if (a == "2") {
				...
				if(data[0]==null){
					message005.innerHTML="Q1. Did not Answer"
				}
			else {message005.innerHTML=data[0];
				}
			if(data[1]==null){
				message006.innerHTML="Q2. Did not Answer"
				}
			else{
				message006.innerHTML=data[1];
				}
			if(data[2]==null){
					message007.innerHTML="Q3. Did not Answer"
				}
			else{
				message007.innerHTML=data[2];
				}
			if(data[3]==null){
					message008.innerHTML="Q4. Did not Answer"
				}
			else{
				message008.innerHTML=data[3];}
			if(data[4]==null){
					message009.innerHTML="Q5. Did not Answer"
				}
			else{
				message009.innerHTML=data[4];}
			if(data[5]==null){
				message010.innerHTML="Q6. Did not Answer"
			}	
			else{
			message010.innerHTML=data[5];}
			
			if(data[6]==null){
				message011.innerHTML="Q7. Did not Answer"
			}
			else{
			message011.innerHTML=data[6];}
			
			if(data[7]==null){
				message012.innerHTML="Q8. Did not Answer"
			}
			else{
			message012.innerHTML=data[7];}
			
			if(data[8]==null){
				message013.innerHTML="Q9. Did not Answer"
			}
			else{
			message013.innerHTML=data[8];}
			
			if(data[9]==null){
				message014.innerHTML="Q10. Did not Answer"
			}
			else{
